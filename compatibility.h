 ...
 */
PHPCHUID_VISIBILITY_HIDDEN int my_setuids(uid_t ruid, uid_t euid, uid_t suid, enum change_xid_mode_t mode);
 ...
 * @retval -1 No (@c errno will be set)
 */
PHPCHUID_VISIBILITY_HIDDEN int my_setgids(gid_t rgid, gid_t egid, gid_t sgid, enum change_xid_mode_t mode);
